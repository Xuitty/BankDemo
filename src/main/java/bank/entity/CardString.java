...
@Component
public class CardString implements Serializable {
	...
	public CardString(Integer cid, Integer ctype, String cnumber, String cdate, String cccv, String cccv_salt,
			Integer cacitve, String ccurrent, String climit, Integer cfailed, Integer aid, Integer uid) {
		this.cid = cid;
		this.ctype = ctype;
	...
	public String toString() {
		return "CardString [cid=" + cid + ", ctype=" + ctype + ", cnumber=" + cnumber + ", cdate=" + cdate + ", cccv="
				+ cccv + ", cccv_salt=" + cccv_salt + ", cacitve=" + cacitve + ", ccurrent=" + ccurrent + ", climit="
				+ climit + ", cfailed=" + cfailed + ", cverify=" + cverify + ", aid=" + aid + ", uid=" + uid
